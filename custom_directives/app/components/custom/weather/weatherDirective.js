directiveApp.directive('tpcWeather', function() {
 	var url =
 		"http://api.openweathermap.org/data/2.5/forecast/daily?mode=json&units=imperial&cnt=7&callback=JSON_CALLBACK&q=";
  return {
    restrict: 'A',
    require: '^ngModel',
    scope: {
    ...
    transclude: true,
    template: '<div class="weather"><div ng-transclude></div><div class="graph"></div></div>',
